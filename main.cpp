...
void print_in_hex(const void* data, size_t size);//áîëüøàÿ
...
int main()
{
    ...
    cout << endl << "print_in_hex of student 0 name  ";
    print_in_hex(&students[1].name,sizeof(students[1].name));
    cout << endl << "print_in_binary of student 0 name  ";
    ...
    cout << endl << "print_in_hex of student 0 year  ";
    print_in_hex(&students[1].year,sizeof(students[1].year));
    cout << endl << "print_in_binary of student 0 year  ";
    print_in_binary(&students[1].year,sizeof(students[1].year));
    cout << endl;//âåçäå åäèíè÷êè!!!!!!!!!!!!!!!!!!!
    ...
    cout << endl << "print_in_hex of student 0 average  ";
    print_in_hex(&students[1].average,sizeof(students[1].average));
    cout << endl << "print_in_binary of student 0 average  ";
    ...
    cout << endl << "print_in_hex of student 0 courses  ";
    print_in_hex(&students[1].courses,sizeof(students[1].courses));
    cout << endl << "print_in_binary of student 0 courses  ";
    print_in_binary(&students[1].courses,sizeof(students[1].courses));
    cout << endl;
    cout << endl << "address of student 0 starosta " << &students[1].starosta;
    cout << endl << "offset of student 0 starosta " <<offsetof(Student, starosta);
    cout << endl << "Size of student 0 starosta  " << sizeof(students[1].starosta);
    cout << endl << "print_in_hex of student 0 starosta  ";
    print_in_hex(&students[1].starosta,sizeof(students[1].starosta));
    cout << endl << "print_in_binary of student 0 starosta  ";
